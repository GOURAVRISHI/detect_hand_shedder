...
# paper is 11 inches wide   # It is related to that particular machine
KNOWN_WIDTH = 11.0

# Applying image processing techniques, and get the bounding box
...
# focalLength will be mentioned on the IP camera
